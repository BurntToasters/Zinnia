...
| :--- | :--- | :--- |
| **EXE: [x64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Windows-x64.exe) / [arm64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Windows-arm64.exe)** | **[Universal DMG](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-macOS.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Linux-x64.AppImage) <!--/  [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-arm64.AppImage) --> |
| <!-- <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div>--> | **[Universal ZIP](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-macOS.zip)** | **DEB:** [x64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Linux-x64.deb) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-arm64.deb)--> |
| <!--*See MSI note below*--> | | **RPM:** [x64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Linux-x64.rpm) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-aarch64.rpm)--> |
| | | **Flatpak:** [x64](https://github.com/BurntToasters/Zinnia/releases/download/v0.5.0-beta.9/Zinnia-Linux-x64.flatpak) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-aarch64.flatpak)--> |
...
## Changes in `v0.5.0-beta.9 (RC):`
* **Misc:** General bug fixes and UI improvements for v0.5.0 STABLE.

## Changes in `v0.5.0-beta.8:`
- **UI:** Titlebar UI fixes for macOS and Windows.

## Changes in `v0.5.0-beta.7:`
* **UI:** Major visual and functional overhauls to take inspiration from the design language of my other app IYERIS.

## Changes in `v0.5.0-beta.6:`
- **Integration:** Fixes to the app integrations.
- **Misc:** General Bug Fixes.

## Changes in `v0.5.0-beta.5:`
- **Default App:** Added the ability for Zinnia to become the default system archiver in settings!
  - Added a reset action for restoring supported archive formats back to the system archiver when the platform supports it.
